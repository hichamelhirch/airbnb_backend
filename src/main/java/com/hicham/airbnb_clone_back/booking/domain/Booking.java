package com.hicham.airbnb_clone_back.booking.domain;
...
public class Booking extends AbstractAuditingEntity<Long> {
    ...
    @SequenceGenerator(name = "booking_generator", sequenceName = "booking_generator", allocationSize = 1)
    @Column(name = "id")
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        return totalPrice == booking.totalPrice && numberOfTravelers == booking.numberOfTravelers && Objects.equals(id, booking.id) && Objects.equals(publicId, booking.publicId) && Objects.equals(startDate, booking.startDate) && Objects.equals(endDate, booking.endDate) && Objects.equals(fkTenant, booking.fkTenant) && Objects.equals(fkListing, booking.fkListing);
    }

    @Override
    public int hashCode() {
        return Objects.hash(
                publicId, startDate, endDate, totalPrice, numberOfTravelers, fkTenant, fkListing);
    }
}
